...
export const PROPERTIES = [
  {
    slug: 'forest-hill-skyline',
    name: 'London Skyline Views | PS5 & Free Parking, 2 BR',
    ...
    address: 'Forest Hill, London SE23',
    type: 'Serviced stay',
    zone: 'Zone 3',
    ...
    checkInFrom: '15:00',
    available: true,
    image: '/forest-hill-1.jpg',
    images: Array.from({ length: 8 }, (_, index) => `/forest-hill-${index + 1}.jpg`),
    ...
    description:
      'A calm, stylish serviced apartment in South East London. It combines a well-equipped living space, fast Wi-Fi, and hotel-style guest welcome details for a comfortable short stay.',
  ...
  {
    slug: 'london-cinema-home',
    name: 'Stylish 2BR Home w Cinema Room Near Central London',
    ...
    checkInFrom: '15:00',
    available: true,
    image: '/cinema-home-1.jpg',
    images: Array.from({ length: 8 }, (_, index) => `/cinema-home-${index + 1}.jpg`),
    summary: 'A two-bedroom South London home with a dedicated cinema room, full kitchen and space for up to four guests.',
    description: 'Settle into a spacious two-bedroom home in South London. A bright ground-floor living space and fully equipped kitchen make everyday stays easy, while the lower-ground-floor cinema room and dining area offer somewhere to unwind. With Wi-Fi, a workspace and self check-in, the home suits family visits, business trips and longer stays.',
  ...
  {
    slug: 'private-coach-house',
    name: 'Stylish Private Coach House | Near Central London',
